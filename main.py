...
def train(epoch, index_tra, y_tra, index_val, y_val):
    ...
    #output_valid.append(time_over-time_begin)
    # with open('./output/records_valid.csv', mode='a', newline='') as file:
    ...
    #output_train.append(AUC_train)
    #output_train.append(AUPR_train)
    #output_train.append(time_over-time_begin)
    # with open('./output/records_train.csv', mode='a', newline='') as file:
    #     writer = csv.writer(file)
